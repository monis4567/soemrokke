...
#SBATCH -c 1
#SBATCH -t 1:00:00
#SBATCH -J 02A_unzip_genome
#SBATCH -o stdout_02A_unzip_genome.txt
#SBATCH -e stderr_02A_unzip_genome.txt
...
#move the raw dataset that was decompressed in the previous part00B
